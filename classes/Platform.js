...
module.exports = class Platform extends Document {
     ...
     * @param {boolean} shares Manage the number times the posts are shared (like retweets)
     ...
     */
    constructor(_id, name, color, url, account, views, shares, likes, comments, clics, visits) {
        super(_id);
        this.name = name;
        this.color = color;
        this.url = url;
